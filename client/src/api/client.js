...
export const api = {
  ...
  // The short confirmation texts — one for the client, one for the instructor
  // (see server/routes/schedule.js).
  getConfirmTextPreview: (who, kind, id) =>
    request(`/schedule/${kind === 'session' ? 'sessions' : 'schedules'}/${id}/${who}-text-preview`),
  sendConfirmText: (who, kind, id, data = {}) =>
